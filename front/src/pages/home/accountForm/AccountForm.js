        ...
        <div className={classes.accountForm}>
            {user.photo ?
                ...
                <div className={classes.photoContainer}>
                    <div className={classes.defaultPhoto}>
                        <svg width="100" height="100" viewBox="0 0 68 60" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {!isEdit ?
                ...
                <div className={classes.editContainer}>
                    <Input label={"Отображаемое имя"} defaultValue={user.displayName}
                           name={"displayName"} type={"text"} onChange={onChangeHandler} error={{}}/>
                    <Input label={"Телефон"} defaultValue={user.phone}
                           name={"phone"} type={"text"} onChange={onChangeHandler} error={{}}/>
                    <Input label={"Город"} defaultValue={user.city}
                           name={"city"} type={"text"} onChange={onChangeHandler} error={{}}/>
